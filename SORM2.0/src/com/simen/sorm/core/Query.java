...
public abstract class Query implements Cloneable{
	...
	public List queryRows(String sql, Class clas, Object[] params) {
		return (List)executeQueryTemplate(sql, clas, params, new CallBack() {
			@Override
	...
	public Object queryById(Class clazz, Object id) {
		...
		// 获得主键字段名称 （主键不一定叫id！！）
		ColumnInfo primKey = tableInfo.getPrimKey();
		String sql = "select * from " + tname + " where " + primKey.getName() + "=?";
		return querySingleRow(sql, clazz, new Object[] {id});
	}
